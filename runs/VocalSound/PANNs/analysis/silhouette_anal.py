...
if __name__ == '__main__':
    ...
    org_scr = silhouette_inference(args=args, pan=std_pan, clsf=std_clsf, data_loader=eval_loader)

    print('After Adaptation Analysis...')
    load_weight(args=args, panns=std_pan, clsf=std_clsf, mode='KD')
    adpt_scr = silhouette_inference(args=args, pan=std_pan, clsf=std_clsf, data_loader=eval_loader)
