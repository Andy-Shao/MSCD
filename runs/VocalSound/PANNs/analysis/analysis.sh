...
python -m runs.VocalSound.PANNs.analysis.std_anal --dataset 'VocalSound' \
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --output_file 'PAN_VS-C_L1.csv' --batch_size 32 --corruption_level 'L1' \
    --orig_wght_pth $BASE_PATH'/result/VocalSound/PANNs/train' \
    --std_adpt_wght_pth './result/VocalSound/PANNs/KD'

# Silhouette analysis
# python -m runs.VocalSound.PANNs.analysis.silhouette_anal --dataset 'VocalSound' \
#     --eval_set_path $BASE_PATH'/data/VocalSound-C' \
#     --output_file 'silhouette_PAN_VS-C_L2.csv' --batch_size 32 --corruption_level 'L2' \
