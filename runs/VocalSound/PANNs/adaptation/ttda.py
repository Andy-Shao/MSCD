...
from lib.component import Components, ReduceChannel, TimeShift
...
if __name__ == '__main__':
    ...
    adpt_cp_loader = DataLoader(
        dataset=adpt_cp_set, batch_size=args.batch_size, shuffle=True, drop_last=False, num_workers=args.num_workers
    )
