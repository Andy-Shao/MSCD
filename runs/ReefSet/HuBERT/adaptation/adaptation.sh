...
python -m runs.ReefSet.HuBERT.adaptation.kd --dataset 'ReefSet' \
    --adpt_set_path $BASE_PATH'/data/Ada-ReefSet-C' \
    --eval_set_path $BASE_PATH'/data/ReefSet-C' \
    --batch_size 32 --corruption_level 'L2' --max_epoch 2 --pseudo_threshold 7.5 --ctr_rt 0.0 \
    --ctr_dist 'sq_l2' --lr 1e-4 --model_level 'base' \
    --elect_weights '{"WHN":1.0, "ENQ":1.0, "END1":1.2, "END2":1.0, "ENSC":1.0, "PSH":3.0, "TST":1.5}' \
    --orig_wght_pth $BASE_PATH'/result/ReefSet/HuBERT/train' \
    --adpt_wght_pth './result/ReefSet/HuBERT/Teach-Cons'