...
if __name__ == '__main__':
    ...
    org_glb_f1, org_lcl_f1s = mlt_inference(
    ...
    for corruption_type, local_accu in local_f1s.items():
        records.loc[len(records)] = [
            args.arch, param_num, f'{corruption_type}-{args.corruption_level}', org_lcl_f1s[corruption_type], 
            local_accu
        ]
    records.loc[len(records)] = [args.arch, param_num, 'Global', org_glb_f1, global_f1]
