...
export ANAL_FILE_L1='PAN_VS-C_L1-02.csv'
export ANAL_FILE_L2='PAN_VS-C_L2-02.csv'
export DATASET='VS-C'
...
python -m runs.VocalSound.PANNs.adaptation.teach_cons --dataset 'VocalSound' \
    ...
    --adpt_wght_pth $BASE_PATH'/result/VocalSound/PANNs/TTDA' --forbid_ls 'END1' --max_mode --seed $SEED_VAL
...
python -m runs.VocalSound.PANNs.adaptation.teach_cons --dataset 'VocalSound' \
    ...
    --lrs '{"WHN":1e-4, "ENQ":1e-4, "END1":1e-4, "END2":1e-4, "ENSC":1e-4, "PSH":2e-4, "TST":1e-4}' \
    --adpt_wght_pth $BASE_PATH'/result/VocalSound/PANNs/TTDA' --forbid_ls 'END1' --seed $SEED_VAL
