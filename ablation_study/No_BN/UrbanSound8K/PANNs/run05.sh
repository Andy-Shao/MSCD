...
export ANAL_FILE_L1='PAN_US8-C_L1-05.csv'
export ANAL_FILE_L2='PAN_US8-C_L2-05.csv'
...
printf 'L2\n' >> $LOG_FILE
python -m ablation_study.No_BN.UrbanSound8K.PANNs.teach_cons --dataset 'UrbanSound8K' \
...
printf 'L2\n' >> $LOG_FILE
python -m ablation_study.No_BN.UrbanSound8K.PANNs.kd --dataset 'UrbanSound8K' \
    --adpt_set_path $BASE_PATH'/data/Ada-UrbanSound8K-C' \
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
