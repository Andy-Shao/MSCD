...
from runs.UrbanSound8K.AMAuT.util import build_model, load_weight, mlt_inference, store_weight
...
if __name__ == '__main__':
    ...
    for epoch in range(args.max_epoch+1):
        ...
        # amaut_freeze(model=std_aut, drop=False) # No BN mode do not freeze model
