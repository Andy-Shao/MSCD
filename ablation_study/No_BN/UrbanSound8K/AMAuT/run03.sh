...
export ANAL_FILE_L1='AuT_US8-C_L1-03.csv'
export ANAL_FILE_L2='AuT_US8-C_L2-03.csv'
...
python -m runs.UrbanSound8K.AMAuT.adaptation.teach_cons --dataset 'UrbanSound8K' \
    ...
    --adpt_wght_pth $BASE_PATH'/result/UrbanSound8K/AMAuT/TTDA' --seed $SEED_VAL
...
printf 'L2\n' >> $LOG_FILE
python -m ablation_study.No_BN.UrbanSound8K.AMAuT.kd --dataset 'UrbanSound8K' \
    --adpt_set_path $BASE_PATH'/data/Ada-UrbanSound8K-C' \
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
