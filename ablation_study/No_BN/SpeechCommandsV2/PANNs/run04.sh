...
export ANAL_FILE_L1='PAN_SC2-C_L1-04.csv'
export ANAL_FILE_L2='PAN_SC2-C_L2-04.csv'
...
printf 'L2\n' >> $LOG_FILE
python -m ablation_study.No_BN.SpeechCommandsV2.PANNs.teach_cons --dataset 'SpeechCommandsV2' \
...
printf 'L2\n' >> $LOG_FILE
python -m ablation_study.No_BN.SpeechCommandsV2.PANNs.kd --dataset 'SpeechCommandsV2' \
    --adpt_set_path $BASE_PATH'/data/Ada-SpeechCommandsV2-C' \
    --eval_set_path $BASE_PATH'/data/SpeechCommandsV2-C' \
