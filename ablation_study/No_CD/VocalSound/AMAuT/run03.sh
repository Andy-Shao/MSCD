...
export ANAL_FILE_L1='AuT_VS-C_L1-03.csv'
export ANAL_FILE_L2='AuT_VS-C_L2-03.csv'
export DATASET='VS-C'
...
python -m runs.VocalSound.AMAuT.adaptation.teach_cons --dataset 'VocalSound' \
    ...
    --adpt_wght_pth $BASE_PATH'/result/VocalSound/AMAuT/TTDA' --freeze_aut --seed $SEED_VAL
...
python -m runs.VocalSound.AMAuT.adaptation.kd --dataset 'VocalSound' \
    ...
    --adpt_wght_pth './result/VocalSound/AMAuT/Teach-Cons' --freeze_aut --seed $SEED_VAL

printf 'L1\n' >> $LOG_FILE
python -m runs.VocalSound.AMAuT.adaptation.kd --dataset 'VocalSound' \
    --adpt_set_path $BASE_PATH'/data/Ada-VocalSound-C' \
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --batch_size 32 --corruption_level 'L1' --max_epoch 20 --lr '1e-4' --ctr_rt 0.0 \
