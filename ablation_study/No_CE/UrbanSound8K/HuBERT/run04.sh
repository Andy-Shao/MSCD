...
export ANAL_FILE_L1='HuB_US8-C_L1-04.csv'
export ANAL_FILE_L2='HuB_US8-C_L2-04.csv'
...
printf 'L1\n' >> $LOG_FILE
python -m ablation_study.No_CE.UrbanSound8K.HuBERT.kd --dataset 'UrbanSound8K' \
    --adpt_set_path $BASE_PATH'/data/Ada-UrbanSound8K-C' \
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
